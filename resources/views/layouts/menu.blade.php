    ...
    <div class="container">
        <div class="site-navigation d-flex justify-content-between align-items-center">
            <a href="#" class="logo m-0">
                <img src="{{ asset('images/logo.png') }}" alt="Saffwah Tour Travel Logo" style="max-height: 50px; /* Sesuaikan tinggi logo */">
            </a>
            ...
            >
                <li class="active"><a href="{{ route('home') }}" style="color: #333; font-weight: bold;">BERANDA</a></li>
                ...
                <li><a href="{{ route('login') }}" class="btn btn-login" style="color: #fff; background-color: #ff6347; font-weight: bold;">LOGIN</a></li>
            </ul>
